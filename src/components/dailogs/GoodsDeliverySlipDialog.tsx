  ...
  const renderProductRow = ({ item, index }: { item: any, index: number }) => {
    return (
      <View key={index} style={styles.tableRow}>
        ...
        <Text style={[styles.tableCell, styles.cellBold, { flex: 2, textAlign: 'center' }]}>{item.qty || 0}</Text>
        <Text style={[styles.tableCell, styles.cellBold, { flex: 2, textAlign: 'center' }]}></Text>
      </View>
    );
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.tableContainer}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderText, { flex: 2, textAlign: 'center' }]}>Ordered Qty</Text>
            <Text style={[styles.tableHeaderText, { flex: 2, textAlign: 'center' }]}>Received Qty</Text>
          </View>
